...
final class ConvertPlugServices {
	 ...
	 */
	private static $services_data = array(
		...
		'moosend'          => array(
			...
			'url'   => 'https://help.moosend.com/hc/en-us/articles/208061865-How-do-I-connect-to-the-Moosend-Web-API-',
		),
		'mymail'           => array(
			'type'  => 'autoresponder',
			'name'  => 'Mailster',
	...
	public static function render_service_accounts() {
		...
		$url = ( isset( $post_data['service'] ) ) ? self::$services_data[ $post_data['service'] ]['url'] : '';
