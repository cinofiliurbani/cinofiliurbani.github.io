...
class CP_Info_Bar extends cp_Framework {
	...
	public function __construct() {
		self::$settings = array(
			'title'       => __( 'Info Bar', 'convertpro' ),
			'description' => __( 'A notification or an opt-in form that slides in and remains at the top or bottom of the page.', 'convertpro' ),
		);
	...
	public function get_options() {
		...
		$options = parent::cp_remove_field_options(
			...
			array( 'back_color', 'back_color_hover', 'title', 'text_hover_color', 'field_box_shadow', 'failed_message', 'submit_message_text_color', 'submit_message_bg_color', 'submit_message_layout', 'btn_url', 'btn_url_target', 'btn_url_follow', 'btn_step', 'field_action', 'submit_message', 'label_action', 'label_box_shadow', 'submit_message_font_size', 'label_border', 'border_style', 'border_width', 'border_color', 'border_hover_color', 'border_radius', 'field_padding', 'count_as_conversion', 'get_parameter' ),
			$options
		);
		...
		$options = parent::cp_remove_field_options(
			...
			array( 'title', 'font_family', 'font_size', 'text_color', 'text_hover_color', 'back_color', 'back_color_hover', 'letter_spacing', 'btn_text_align', 'line_height', 'label_box_shadow', 'field_box_shadow', 'field_padding' ),
			$options
		);
		...
		$options = parent::cp_remove_field_options(
			...
			array( 'title', 'font_family', 'font_size', 'text_color', 'text_hover_color', 'back_color', 'back_color_hover' ),
			$options
		);
	...
	public function get_design_options() {
		...
		$panel_design_options = array(
			...
			array(
				...
				'name'         => 'panel_position',
				'opts'         => array(
					'title'       => __( 'Position', 'convertpro' ),
					'value'       => 'top',
					'description' => '',
					'options'     => array(
						'top'    => __( 'Top', 'convertpro' ),
						'bottom' => __( 'Bottom', 'convertpro' ),
					),
					'tags'        => 'position',
					'map_style'   => array(
						'parameter' => 'position',
			...
			array(
				...
				'name'         => 'push_page_down',
				'opts'         => array(
					'title'       => __( 'Push Page Down', 'convertpro' ),
					'value'       => false,
					'on'          => __( 'YES', 'convertpro' ),
					'off'         => __( 'NO', 'convertpro' ),
					'description' => __( 'Push page down when info bar is enabled.', 'convertpro' ),
					'tags'        => 'toggle',
					'map_style'   => array(
						'parameter' => 'toggle',
					),
			...
			array(
				'type'         => 'switch',
				'class'        => '',
				'name'         => 'info_bar_sticky',
				'opts'         => array(
					'title'       => __( 'Disable Sticky Info-bar', 'convertpro' ),
					'value'       => false,
					'on'          => __( 'YES', 'convertpro' ),
					'off'         => __( 'NO', 'convertpro' ),
					'description' => __( 'Disable the Info bar as Sticky.', 'convertpro' ),
					'tags'        => 'toggle',
					'map_style'   => array(
						'parameter' => 'toggle',
					),
			...
			array(
				'type'           => 'switch',
				'class'          => '',
				'name'           => 'panel_toggle_infobar',
				'opts'           => array(
					'title'       => __( 'InfoBar Toggle', 'convertpro' ),
					'value'       => false,
					'on'          => __( 'YES', 'convertpro' ),
					'off'         => __( 'NO', 'convertpro' ),
			...
			array(
				'type'           => 'colorpicker',
				'class'          => '',
				'name'           => 'toggle_infobar_text_color',
				'opts'           => array(
