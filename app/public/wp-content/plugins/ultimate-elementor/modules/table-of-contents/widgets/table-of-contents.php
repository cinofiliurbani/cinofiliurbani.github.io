...
class Table_Of_Contents extends Common_Widget {
	...
	protected function render() {
		...
		$this->add_render_attribute( 'list-parent-wrapper', 'data-scroll', $settings['scroll_time']['size'] );

		if ( '' !== $settings['scroll_offset_mobile']['size'] ) {
			$this->add_render_attribute( 'list-parent-wrapper', 'data-scroll-offset-mobile', $settings['scroll_offset_mobile']['size'] );
		}

		if ( '' !== $settings['scroll_offset_tablet']['size'] ) {
			$this->add_render_attribute( 'list-parent-wrapper', 'data-scroll-offset-tablet', $settings['scroll_offset_tablet']['size'] );
		}

		if ( '' !== $settings['scroll_offset']['size'] ) {
			$this->add_render_attribute( 'list-parent-wrapper', 'data-scroll-offset', $settings['scroll_offset']['size'] );
		}
